...
<body style=' background-color:#3D5D61;'>
         ...
         <h1 style='color:#C0F1F8; font-size: 22px; text-align: center;'><br><?php echo 'Piramides de Teotihuacán'; ?></h1>
        <BR>
        
         <h2 style='color:#E7EEF1; text-align: justify;margin-left: 150px; margin-right: 150px; font-size: 20px;'>


<?php echo 'Teotihuacán es un amplio complejo arqueológico mexicano al noreste de la Ciudad de México. Por el centro del lugar, que alguna vez fue una floreciente ciudad precolombina, pasa la Calzada de los Muertos. Esta une el Templo de Quetzalcóatl, la Pirámide de la Luna y la Pirámide del Sol. Las dos últimas tienen vistas panorámicas desde sus cimas. Los artefactos del Museo de la Cultura Teotihuacana, en el lugar, incluyen trabajos de alfarería y huesos.'; ?>
</h2>
<br><br><br>
    <div class='root'>
        <div class='gallery'>
